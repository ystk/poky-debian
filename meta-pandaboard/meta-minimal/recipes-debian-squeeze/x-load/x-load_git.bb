...
#SRC_URI_append_pandaboard = " file://name.patch "
...
#DEBIAN_SQUEEZE_MISC_NAME = "x-load"
DEBIAN_SQUEEZE_MISC_NAME = "x-loader"
DEBIAN_SQUEEZE_MISC_GIT = "${DEBIAN_SQUEEZE_GIT_BOOTLOADER}"
#DEBIAN_SQUEEZE_MISC_COMMIT = "v1.5.1"
DEBIAN_SQUEEZE_MISC_COMMIT = "remotes/origin/omap4_dev"

LIC_FILES_CHKSUM = "file://README;beginline=1;endline=152;md5=fb7a7e60aceaa99c529b6c667dfcf474"

PR = "r0"

#COMPATIBLE_MACHINE = "(pandaboard-${BEAGLEBOARD_REV}|omap3evm|overo|bbxmc)"
