...
do_patch_append() {
	bb.build.exec_func('fix_dolt_libtool_path', d)
}
fix_dolt_libtool_path() {
	sed -i "s@\${top_builddir_slash}libtool@\${top_builddir_slash}${HOST_SYS}-libtool@" \
		${S}/build/aclocal.dolt.m4
}
