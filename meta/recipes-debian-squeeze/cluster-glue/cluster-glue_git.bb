#
# linux-ha/cluster-glue_1.0.5.bb
...
EXTRA_OECONF = "--with-daemon-user=hacluster --with-daemon-group=haclient --enable-fatal-warnings=no"

do_install_append() {
	install -m 0644 ${S}/include/glue_config.h ${D}${includedir}
...
PR = "r0"
SRC_URI += "file://fix-config.patch;patch=1 \
            file://volatiles \
	    file://fix-const-cast.patch;patch=1 \
