#
# HIDDEN/recipes-graphics/fontconfig/fontconfig_2.8.0.bb
#
...
DEPENDS = "expat freetype zlib libxml2"
RDEPENDS = "expat freetype zlib libxml2"
#PR = "r3"
...
PACKAGES =+ "lib${PN} ${PN}-config"

FILES_${PN}-config = "${sysconfdir}/*"
FILES_lib${PN} = "${libdir}/lib${BPN}.so.*"

RDEPENDS_lib${PN} = "${PN}-config"
RDEPENDS_${PN} = "lib${PN}"
