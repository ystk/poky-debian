...
# NOTE: the following scripts are excluded because
# they are not included in Debian netbase package.
#   interfaces, nfsroot
# "init" (/etc/init.d/networking) is included in Debian netbase
# but not install here because debian-squeeze-files provides it.
