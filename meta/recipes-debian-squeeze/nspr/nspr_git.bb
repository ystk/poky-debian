...
S = "${DEBIAN_SQUEEZE_UNPACKDIR}/mozilla/nsprpub"

# NOTE: FILES_* definitions are commented out to fix *.so and
# remove all tests from ${PN}-dev and ${PN}-dbg
