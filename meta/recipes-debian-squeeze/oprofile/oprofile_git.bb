#
# recipes-kernel/oprofile/oprofile_0.9.6.bb
#
...
do_configure_prepend() {
	cat ${S}/m4/binutils.m4 | \
	sed "s%lib=/usr/lib/libbfd.a%lib=${STAGING_DIR_TARGET}/usr/lib/libbfd.a%" > ${S}/m4/binutils.m4.backup
	mv ${S}/m4/binutils.m4.backup ${S}/m4/binutils.m4
}
