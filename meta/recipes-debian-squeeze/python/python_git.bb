...
# 01: fix the following compile error (modified)
#   "/bin/sh: line 1: ./python: cannot execute binary file"
# 02: remove unneeded test
SRC_URI = " \
file://01-use-proper-tools-for-cross-build.patch \
file://02-remove-test-for-cross.patch \
file://07-linux3-regen-fix.patch \
...
# remove all macros because all of them are not required in poky
SRC_URI += "file://series.poky"

do_patch_srcpkg() {
	cd ${S}
	cp ${WORKDIR}/series.poky ${S}/debian/patches/series
