...
file://src/passwd.c;firstline=8;endline=30;md5=82afa0dcf02736e3a90ab99b40114ee8 \
"

# shadow-4.1.5-stdarg.patch: Required to fix strange compile errors
SRC_URI = " \
file://login_defs_pam.sed \
${@base_contains('DISTRO_FEATURES', 'pam', '${PAM_SRC_URI}', '', d)} \
file://securetty \
...
# attr is required by default but it is not available in debian source
# (debian/rules also add --without-attr)
EXTRA_OECONF += "--without-attr"

# need to redefine because pam-plugin-* packages are all merged to 
# libpam-modules 
PAM_PLUGINS = "libpam-runtime libpam-modules"
