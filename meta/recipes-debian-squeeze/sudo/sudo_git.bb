...
#
# recipes-extended/sudo/sudo_1.8.1p2.bb
#
...
# because libpam was re-splited packages
RDEPENDS_${PN} += " ${@base_contains('DISTRO_FEATURES', 'pam', 'libpam-modules', '', d)}"

SRC_URI = " \
file://libtool.patch \
file://0001-sudo-build-testsudoers-error-bugfix.patch \
${@base_contains('DISTRO_FEATURES', 'pam', '${PAM_SRC_URI}', '', d)} \
"
