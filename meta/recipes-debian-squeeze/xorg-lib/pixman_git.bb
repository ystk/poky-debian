...
LIC_FILES_CHKSUM = " \
file://COPYING;md5=b43792c98541e935adb39f751a45bd55 \
file://pixman/pixman-matrix.c;endline=21;md5=4a018dff3e4e25302724c88ff95c2456 \
file://pixman/pixman-arm-neon.c;endline=27;md5=c749a90ab12f15a5717f3133116a1a44 \
"
# May-2013 neon not enabled on ebx-cubox
NEON = "${@bb.utils.contains("TUNE_FEATURES", "neon", "", "--disable-arm-neon" ,d)}"
EXTRA_OECONF = "--disable-gtk ${NEON}"
